...
export default function Home() {
  return (
    <div className="p-4 pt-1  min-h-screen flex flex-col justify-between ">
      <Navbar />
      <div className="md:top-[55px] top-[40px] flex items-center justify-center w-full text-[68px] md:text-[100px] lg:text-[130px] text-center absolute  left-0 font-bold">
        <p>Hasanali </p>
      ...
      <div className="pt-[20px] flex flex-col gap-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 w-full">
          <div className="flex w-full  lg:w-3/4 gap-4">
            <div className="card  w-1/2 md:w-2/3">
              <div className="flex items-center justify-between w-full">
                <div>Contact</div>
                <ArrorUpRight />
              </div>
          ...
          <div className="flex w-full lg:w-1/4 flex-row lg:flex-col gap-4">
            <div className="card mini lg:!h-1/2 !w-full">Stack</div>
